 ...
 */
final class Version20221211162329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equip (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, cicle VARCHAR(10) NOT NULL, curs VARCHAR(10) NOT NULL, imatge VARCHAR(255) NOT NULL, nota NUMERIC(2, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
